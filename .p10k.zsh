# Generated by Powerlevel10k configuration wizard on 2019-08-22 at 21:52 CEST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 61305.
# Wizard options: nerdfont-complete + powerline, small icons, classic, darkest,
# slanted separators, sharp heads, blurred tails, 1 line, compact, many icons, fluent.
...
() {
  ...
  vcs+=':-%244F@%76F${VCS_STATUS_COMMIT[1,8]}}'
  # ':master' if the tracking branch name differs from local branch.
  vcs+='${${VCS_STATUS_REMOTE_BRANCH:#$VCS_STATUS_LOCAL_BRANCH}:+%244F:%76F${VCS_STATUS_REMOTE_BRANCH//\%/%%}}'
  # '#tag' if on a tag.
  vcs+='${VCS_STATUS_TAG:+%244F#%76F${VCS_STATUS_TAG//\%/%%}}'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%n%244F at %227F%m'
  ...
  ###################################[ vi_mode: vi indicator ]##################################
  # INSERT mode indicator
  typeset -g POWERLEVEL9K_VI_INSERT_MODE_STRING'INSERT'
  # NORMAL mode indicator
  typeset -g POWERLEVEL9K_VI_NORMAL_MODE_STRING'NORMAL'
  # VISUAL mode indicator
  typeset -g POWERLEVEL9K_VI_VISUAL_MODE_STRING'VISUAL'
  #  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_BACKGROUND=grey
